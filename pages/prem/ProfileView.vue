...
import PremUserAvatarCurrentUserWithUpload from "@/components/prem/UserAvatarCurrentUserWithUpload.vue";
import PremCardBoxBillingItem from "@/components/prem/CardBoxBillingItem.vue";
import PremCardBoxPaymentMethod from "@/components/prem/CardBoxPaymentMethod.vue";
import PremUserCardProfileNumber from "@/components/prem/UserCardProfileNumber.vue";
import PremSectionBannerProfile from "@/components/prem/SectionBannerProfile.vue";
      ...
      <div class="grid grid-cols-1 xl:grid-cols-2 gap-6 mb-6">
        <CardBox flex="flex-row" class="items-center">
          <div class="flex justify-start items-start">
            <PremUserAvatarCurrentUserWithUpload
