...
import PremFormField from "@/components/prem/FormField.vue";
import PremFormControl from "@/components/prem/FormControl.vue";
        ...
        >
          ...
          >
            <PremFormField addons>
              <PremFormControl type="static" model-value="+44 (0)" first-addon />
              <PremFormControl
                v-model="form.phone"
                type="tel"
          ...
          <PremFormField help="Static prefix with dropdown at the end" horizontal>
            <PremFormField addons>
          ...
          <PremFormField help="Static prefix with button at the end" horizontal>
            <PremFormField addons>
              <PremFormControl type="static" model-value="IPv6:" first-addon />
              <PremFormControl
                v-model="form.ipv6"
                type="text"
